Libft
Libft, C dilinde temel string ve memory işlemleri ile bazı yardımcı fonksiyonların yeniden implemente edildiği bir kütüphanedir. Bu proje 42 okulu müfredatına uygundur ve standart C fonksiyonlarının bazılarını kendi fonksiyonlarınla yazmanı sağlar.
...
Kod Norm kurallarına uygun olmalı; Norm hatası = 0 puan.
...
Malloc ile ayrılan bellek mutlaka free edilmeli.
